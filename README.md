...
- استخراج الفيديو يبدأ عبر **Twitter Syndication API**، وإذا تعذر المصدر الأول يستخدم **FxTwitter API** العام كمسار بديل، بدون Cookie أو API key. المسار البديل لا يسجّل الدخول إلى X ولا يتجاوز صلاحيات أو تحقق العمر في X.
...
- تويتر/X أو الخدمات الوسيطة قد تغيّر بنيتها من وقت لآخر. البوت يحاول مصدرين عامين بشكل متتالٍ، لذلك توقف أحدهما لا يعني توقف البوت بالكامل.
